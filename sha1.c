...
/**
 */
void __device__ sha1_init(sha1nfo *s);
/**
 */
void __device__ sha1_writebyte(sha1nfo *s, uint8_t data);
/**
 */
void __device__ sha1_write(sha1nfo *s, const char *data, size_t len);
/**
 */
uint8_t* __device__ sha1_result(sha1nfo *s);
/**
 */
void __device__ sha1_initHmac(sha1nfo *s, const uint8_t* key, int keyLength);
/**
 */
uint8_t* __device__ sha1_resultHmac(sha1nfo *s);
...
uint32_t __device__ sha1_rol32(uint32_t number, uint8_t bits) {
	return ((number << bits) | (number >> (32-bits)));
}

void __device__ sha1_hashBlock(sha1nfo *s) {
	uint8_t i;
...
void __device__ sha1_addUncounted(sha1nfo *s, uint8_t data) {
...
void __device__ sha1_pad(sha1nfo *s) {
